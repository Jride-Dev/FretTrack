import {
  ...
  canManageJobCharges as canManageJobChargesForRole,
  canRecordJobPayments as canRecordJobPaymentsForRole,
  canIssuePaymentAdjustments as canIssuePaymentAdjustmentsForRole,
  canFinalizeJobInvoices as canFinalizeJobInvoicesForRole,
...
export function getAppAccess({
  ...
  return {
    ...
    canManageJobCharges: !hasSupabaseConfig || canManageJobChargesForRole(permissionContext),
    canRecordJobPayments: !hasSupabaseConfig || canRecordJobPaymentsForRole(permissionContext),
    canIssuePaymentAdjustments: !hasSupabaseConfig || canIssuePaymentAdjustmentsForRole(permissionContext),
    canFinalizeJobInvoices: !hasSupabaseConfig || canFinalizeJobInvoicesForRole(permissionContext),
