...
export function normalizeCustomer(customer = {}) {
  ...
  return {
    ...
    serviceReminderOptIn: customer.serviceReminderOptIn ?? customer.service_reminder_opt_in ?? false,
    serviceReminderConsentAt: customer.serviceReminderConsentAt || customer.service_reminder_consent_at || '',
    serviceReminderConsentSource: customer.serviceReminderConsentSource || customer.service_reminder_consent_source || '',
    phone,
