...
export const PREMIUM_FEATURES = {
  ...
  AUTOMATED_SERVICE_REMINDERS: 'automated_service_reminders',
...
const defaultEntitlements = {
  ...
  keyboard_repair: false,
  scheduled_email: false,
  loyalty_program: false,
  automated_service_reminders: false,
...
const tierEntitlements = {
  ...
  [SUBSCRIPTION_TIERS.PRO]: {
    ...
    keyboard_repair: true,
    scheduled_email: true,
    loyalty_program: true,
    automated_service_reminders: true,
    max_users: 10,
...
export const premiumFeatureGroups = [
  {
    ...
    features: [
      ...
      [PREMIUM_FEATURES.KEYBOARD_REPAIR, 'Keyboard Repair'],
      [PREMIUM_FEATURES.SCHEDULED_EMAIL, 'Scheduled Email'],
      [PREMIUM_FEATURES.LOYALTY_PROGRAM, 'Loyalty Program'],
      [PREMIUM_FEATURES.AUTOMATED_SERVICE_REMINDERS, 'Automated Service Reminders'],
...
export function normalizeEntitlementSnapshot(snapshot = {}, shopId = '') {
  ...
  return {
    ...
    access: {
      ...
      canUseKeyboardRepair: Boolean(entitlements.keyboard_repair),
...
export function canUseKeyboardRepair(snapshot) {
  return getShopFeatureValue(snapshot, PREMIUM_FEATURES.KEYBOARD_REPAIR);
}
