...
assert.match(billingActions, /buildAddPaymentJob\(draftJob, payment, crypto\.randomUUID\(\)\)/, 'Adding payments must use the extracted pure payment helper.');
assert.match(billingActions, /buildUpdatePaymentJob\(draftJob, paymentId, field, value\)/, 'Updating payments must use the extracted pure payment helper.');
assert.match(billingActions, /buildRemovePaymentJob\(draftJob, paymentId\)/, 'Removing payments must use the extracted pure payment helper.');
