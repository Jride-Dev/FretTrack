...
assert.match(jobPrintSheet, /formatLength\(final\.relief, lengthUnit\)/, 'The printed Job Sheet must use the unit supplied from Shop Settings.');
assert.doesNotMatch(jobPrintSheet, /final\.lengthUnit \|\| final\.reliefUnit/, 'The printed Job Sheet must not prefer stale per-stage unit metadata.');
