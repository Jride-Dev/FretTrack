...
The job-service normalization, query, and child-synchronization split is complete behind compatibility exports. Transitional duplicate implementations have been removed; the remaining facade work is limited to messaging and parent mutations.
