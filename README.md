...
- First-run shop onboarding/profile setup, private shop logo storage, and print sheet logo support.
- Post-login shop selection for multi-shop users and self-service beta shop creation.
