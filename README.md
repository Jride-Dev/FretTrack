...
The production database is current through `20260827181934_stripe_webhook_atomic_event_claim.sql`. The commercial app, public pricing/legal documentation, Stripe billing Edge Functions, live webhook, and customer portal are deployed. New Checkout is open to eligible shop owners and administrators through the reviewed launch gate with required Terms acceptance; Automated Reminder rules remain disabled until a Pro/Enterprise shop explicitly configures and enables one.
