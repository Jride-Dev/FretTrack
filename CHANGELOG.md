...
- Fixed landing Worker routing for public docs so `/docs`, `/docs.html`, and clean `/docs/...` how-to pages consistently return CSP, Permissions-Policy, Referrer-Policy, and X-Content-Type-Options headers.
