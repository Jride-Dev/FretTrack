...
- Added a public Docs hub at `https://frettrack-app.com/docs` so beta testers and shops can reach customer-facing help, support, legal pages, and checklist downloads without relying on GitHub Wiki access.
