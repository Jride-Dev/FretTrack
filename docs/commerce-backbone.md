...
The older `transaction_events` and `payment_events` backbone is still not a general ledger and does not yet replace work-order payment storage. Processor-backed refunds and secure public invoice links remain separate follow-on slices.
